...
const initialToast = { visible: false, message: '', isError: false };
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/terms.html" element={<PolicyPage type="terms" {...sharedPageProps} />} />
        <Route
          path="/login"
          element={<LoginPage t={t} language={language} onLanguageChange={setLanguage} />}
        />
        <Route
          path="/admin"
          element={(
            <ProtectedRoute>
              <AdminPage t={t} language={language} onLanguageChange={setLanguage} />
            </ProtectedRoute>
          )}
        />
        <Route
